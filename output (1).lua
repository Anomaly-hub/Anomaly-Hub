local AmountOfAdmins = 0
        for _, player in pairs(game.Players:GetPlayers()) do
            ...
            local PlayersRank = player:GetRankInGroup(4606577)
            if PlayersRank >= 8 then
                AmountOfAdmins = AmountOfAdmins + 1
            end
        end
if AmountOfAdmins == 0 then
    local value = 0
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Notice", Text = 'There is a moderator in-game.'})
end
